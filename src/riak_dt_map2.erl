...
%% `field_value()' is a two-tuple of `dot`->`crdt()' mappings.
%%
...
%% this means in practice is, if a field is removed, and concurrently
...
%% <h2>Merging/Size</h2>
%%
%% When any pair of Maps are merged, the embedded CRDTs are
%% merged. The size of the map will be roughly the size of all the
%% embedded CRDTs, plus the extra per-field causal information
%% (typically a single dot.)
%%
