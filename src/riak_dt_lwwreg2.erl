%% -------------------------------------------------------------------
%%
%% riak_dt_lwwreg2: A dot based last-write-wins register
%%
...
-type lwwreg() :: {riak_dt_vclok:vclock(), {riak_dt:dot(), {term(), non_neg_integer()}}}.
